...
if (permitirAcceso($_SESSION['usuarios'], 'editarUsuario')) {
?>
<?php 
    include("db.php");
$id=$_GET['CedulaProfesional'];
$sql="SELECT * FROM usuarios WHERE CedulaProfesional='$id'";
...
<nav class="navbar navbar-expand-md navbar-dark bg-dark fixed-top "><!--info -->
 ...
 <div class="container">
      <div class="row justify-content-center mt-5 pt-5 ">
        <div class="col-md-7">
          <h1 class="display-8">Modificar usuario</h1>
          <hr class="bg-info">
          ...
          <form action="metodoUsuario.php" method="post" name="actualizar">
            ...
            <input type="hidden" name="nombreU" value="<?php echo $fila['NombreCompleto'] ?>">
            <div class="row form-group">
              <label for="nombre" class="col-form-label col-md-4">Nombre Completo:</label> 
              <div class="col-md-8">
                <input type="text" name="nombre" class="form-control" required pattern="[A-Za-záéíóúÁÉÍÓÚ ]+" value="<?php echo $fila['NombreCompleto'] ?>">
              </div>
            </div>
            <div class="row form-group">
              <label for="cedula" class="col-form-label col-md-4">Cedula Profesional:</label> 
              <div class="col-md-8">
                <input type="text" name="cedula" class="form-control" required value="<?php echo $fila['CedulaProfesional'] ?>">
              </div>
            </div>
            <div class="row form-group">
            ...
            <div class="row form-group">
              ...
              <div class="col-md-8">
               <input type="text" name="especialidad" class="form-control" required value="<?php echo $fila['Especialidad'] ?>">
              </div>
            </div>
            <div class="row form-group">
              <label for="correo" class="col-form-label col-md-4">Correo electronico:</label>   
              <div class="col-md-8">
                <input type="text" name="correo" class="form-control" required value="<?php echo $fila['Correo'] ?>">
              </div>
            </div>
            <div class="row form-group">
              <label for="user" class="col-form-label col-md-4">Usuario:</label> 
              <div class="col-md-8">
               <input type="text" name="user" class="form-control" required pattern="[A-Za-z0-9]+" value="<?php echo $fila['Usuario'] ?>">
              </div>
            </div>
            <div class="row form-group">
              <label for="pass" class="col-form-label col-md-4">Contraseña:</label> 
              <div class="col-md-8">
               <input type="password" name="pass" class="form-control" required maxlength="10" minlength="6" value="<?php echo $fila['Contraseña'] ?>">
              </div>
            </div>
            <div class="row form-group">
            ...
            <div class="row form-group">
              ...
              <div class="col-md-8">
               <input type="date" name="fecha" class="form-control" value="<?php echo $fila['FechaAltaSistema'] ?>">
              </div>
            </div>
            ...
            <button type="button" class="btn btn-secondary"><a href="admonUsuario.php"class="text-white" style="text-decoration:none">Regresar</a></button>
       		 </div>
          </form>
        </div>
      </div>
