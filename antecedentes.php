...
if (permitirAcceso($_SESSION['usuarios'], 'antecedentes')) {
?>
<!DOCTYPE html>
<html lang="en">
<head>
      ...
      <div class="row justify-content-center mt-5 pt-5 ">
        <div class="col-md-12">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
              <li class="breadcrumb-item active"><a href="agregarPaciente.php">Registro</a></li>
              <li class="breadcrumb-item" aria-current="page">Antecedentes</a></li>
            </ol>
         </nav>
        </div>
        <div class="col-md-7">
          <h1 class="display-8">Antecedentes de los pacientes</h1>
          <hr class="bg-info">
          ...
          <form action="metodoUsuario.php" method="post">
            ...
            <div class="row form-group">
              ...
              <div class="col-md-8">
                <?php
                  include ('db.php');
                  $ejemplo = 'SELECT Max(idpaciente) FROM paciente';
