                ...
                <div class="row"> 
                  <div class="col-md-12">   
                    ...
                    if ($resultado->num_rows>0) {
                     ...
                     /** ELIMINAR  **/
                     echo "<td style='vertical-align:middle;'> <a href='metodoUsuario.php?opcion=6&paciente_idpaciente=".$fila['paciente_idpaciente']."'> <i class='fas fa-trash-alt'style='color:red;'></i></a></td>"; 
                   }
                   echo "</center>";
                 }
                 ?>
